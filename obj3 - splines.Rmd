...
obj3_var <- obj3_var %>% rename(Volume_grey_white_normalised = "Volume_of_brain,_grey+white_matter_(normalised_for_head_size)")

obj3_var <- obj3_var %>% rename(Total_volume_white_hyperintensities = "Total_volume_of_white_matter_hyperintensities_(from_T1_and_T2_FLAIR_images)")
```
...
relevant_vars_1 <- c("Volume_grey_white_normalised", "cluster")
...
# Split female data
train_indices_f1 <- createDataPartition(female_obj3_1$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
# Split male data
train_indices_m1 <- createDataPartition(male_obj3_1$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
# Model 1: Base Model (Unadjusted)
model1_f <- lm(Volume_grey_white_normalised ~ cluster, data = train_female_obj3_1)
summary(model1_f)

# Make predictions on the testing data
predictions_model1_f<- predict(model1_f, newdata = test_female_obj3_1)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model1_f - test_female_obj3_1$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model1_f - test_female_obj3_1$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model1_f_aic <- AIC(model1_f)
model1_f_bic <- BIC(model1_f)

# Print the results
cat("AIC for the model1_f:", model1_f_aic, "\n")
cat("BIC for the model1_f:", model1_f_bic, "\n")

# Plot predictions vs actual values
plot(test_female_obj3_1$Volume_grey_white_normalised, predictions_model1_f,
...
# Model 1: Base Model (Unadjusted)
model1_m <- lm(Volume_grey_white_normalised ~ cluster, data = train_male_obj3_1)
summary(model1_m)

# Make predictions on the testing data
predictions_model1_m<- predict(model1_f, newdata = test_male_obj3_1)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model1_m - test_male_obj3_1$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model1_m - test_male_obj3_1$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model1_m_aic <- AIC(model1_m)
model1_m_bic <- BIC(model1_m)

# Print the results
cat("AIC for the model1_m:", model1_m_aic, "\n")
cat("BIC for the model1_m:", model1_m_bic, "\n")

# Plot predictions vs actual values
plot(test_male_obj3_1$Volume_grey_white_normalised, predictions_model1_m,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
```
...
# Select relevant variables
relevant_vars_2 <- c("Volume_grey_white_normalised", "cluster", "age_at_diagnosis", 
...
# Split female data
train_indices_f2 <- createDataPartition(female_obj3_2$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
# Split male data
train_indices_m2 <- createDataPartition(male_obj3_2$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
model_formula2 <- Volume_grey_white_normalised ~ cluster + ns(age_at_diagnosis, df = 3) + Qualification_ + ns(Townsend_deprivation_index_at_recruitment, df =3) + Smoking_ever + Drinking_ever + ns(Summed_MET_minutes_per_week_for_all_activity, df=3)

# Adjust the baseline level for the 'cluster' variable
train_female_obj3_2$cluster <- relevel(train_female_obj3_2$cluster, ref = "Age-related")

# Model 2 female
model2_f <- lm(model_formula2, data = train_female_obj3_2)
summary(model2_f)

# Make predictions on the testing data
predictions_model2_f<- predict(model2_f, newdata = test_female_obj3_2)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model2_f - test_female_obj3_2$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model2_f - test_female_obj3_2$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model2_f_aic <- AIC(model2_f)
model2_f_bic <- BIC(model2_f)

# Print the results
cat("AIC for the model2_f:", model2_f_aic, "\n")
cat("BIC for the model2_f:", model2_f_bic, "\n")

# Plot predictions vs actual values
plot(test_female_obj3_2$Volume_grey_white_normalised, predictions_model2_f,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
...
spline_model <- lm(Volume_grey_white_normalised ~ ns(age_at_diagnosis, df = 3), data = train_female_obj3_2)
...
ggplot(train_female_obj3_2, aes(x = age_at_diagnosis, y = Volume_grey_white_normalised)) +
  ...
  labs(title = "Female: Natural Spline Transformation for Age at Diagnosis",
       x = "Age at Diagnosis",
       y = "Volume (Grey-White Normalised)",
       color = "Legend") +
  theme_minimal() +
...
spline_model <- lm(Volume_grey_white_normalised ~ ns(Townsend_deprivation_index_at_recruitment, df = 3), data = train_male_obj3_2)
summary(spline_model)
...
ggplot(train_male_obj3_2, aes(x = Townsend_deprivation_index_at_recruitment, y = Volume_grey_white_normalised)) +
  geom_point(alpha = 0.3, aes(color = "Observed Data")) +
...
# Fit the spline model with ns-splines (degree = 3)
spline_model <- lm(Volume_grey_white_normalised ~ ns(Townsend_deprivation_index_at_recruitment, df = 3), data = train_female_obj3_2)
summary(spline_model)
...
# Plot the original data points and the spline curve with confidence intervals
ggplot(train_female_obj3_2, aes(x = Townsend_deprivation_index_at_recruitment, y = Volume_grey_white_normalised)) +
  geom_point(alpha = 0.3, aes(color = "Observed Data")) +
  geom_line(data = preds_df, aes(x = Townsend_deprivation_index_at_recruitment, y = fit, color = "Predicted Line"), size = 1) +
  geom_line(data = preds_df, aes(x = Townsend_deprivation_index_at_recruitment, y = upper, color = "Confidence Interval"), linetype = "dashed") +
  geom_line(data = preds_df, aes(x = Townsend_deprivation_index_at_recruitment, y = lower, color = "Confidence Interval"), linetype = "dashed") +
...
# Fit the spline model with ns-splines (degree = 3)
spline_model <- lm(Volume_grey_white_normalised ~ ns(Summed_MET_minutes_per_week_for_all_activity, df = 3), data = train_female_obj3_2)
summary(spline_model)
...
# Plot the original data points and the spline curve with confidence intervals
ggplot(train_female_obj3_2, aes(x = Summed_MET_minutes_per_week_for_all_activity, y = Volume_grey_white_normalised)) +
  geom_point(alpha = 0.3, aes(color = "Observed Data")) +
...
# Model 2 male
model2_m <- lm(model_formula2, data = train_male_obj3_2)
summary(model2_m)

# Make predictions on the testing data
predictions_model2_m<- predict(model2_m, newdata = test_male_obj3_2)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model2_m - test_male_obj3_2$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model2_m - test_male_obj3_2$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model2_m_aic <- AIC(model2_m)
model2_m_bic <- BIC(model2_m)

# Print the results
cat("AIC for the model2_m:", model2_m_aic, "\n")
cat("BIC for the model2_m:", model2_m_bic, "\n")

# Plot predictions vs actual values
plot(test_male_obj3_2$Volume_grey_white_normalised, predictions_model2_m,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
...
# Fit the spline model with ns-splines (degree = 3) for males
spline_model <- lm(Volume_grey_white_normalised ~ ns(age_at_diagnosis, df = 3), data = train_male_obj3_2)
summary(spline_model)
...
# Plot the original data points and the spline curve with confidence intervals for males
ggplot(train_male_obj3_2, aes(x = age_at_diagnosis, y = Volume_grey_white_normalised)) +
  geom_point(alpha = 0.3, aes(color = "Observed Data")) +
  geom_line(data = preds_df, aes(x = age_at_diagnosis, y = fit, color = "Predicted Line"), size = 1) +
  geom_line(data = preds_df, aes(x = age_at_diagnosis, y = upper, color = "Confidence Interval"), linetype = "dashed") +
  geom_line(data = preds_df, aes(x = age_at_diagnosis, y = lower, color = "Confidence Interval"), linetype = "dashed") +
...
# Fit the spline model with ns-splines (degree = 3) for males
spline_model <- lm(Volume_grey_white_normalised ~ ns(Summed_MET_minutes_per_week_for_all_activity, df = 3), data = train_male_obj3_2)
summary(spline_model)
...
# Plot the original data points and the spline curve with confidence intervals for males
ggplot(train_male_obj3_2, aes(x = Summed_MET_minutes_per_week_for_all_activity, y = Volume_grey_white_normalised)) +
  geom_point(alpha = 0.3, aes(color = "Observed Data")) +
  geom_line(data = preds_df, aes(x = Summed_MET_minutes_per_week_for_all_activity, y = fit, color = "Predicted Line"), size = 1) +
  geom_line(data = preds_df, aes(x = Summed_MET_minutes_per_week_for_all_activity, y = upper, color = "Confidence Interval"), linetype = "dashed") +
  geom_line(data = preds_df, aes(x = Summed_MET_minutes_per_week_for_all_activity, y = lower, color = "Confidence Interval"), linetype = "dashed") +
...
relevant_vars_3 <- c("Volume_grey_white_normalised", "cluster", "age_at_diagnosis", 
                     "Qualification_", "Townsend_deprivation_index_at_recruitment", 
                     "Smoking_ever", "Drinking_ever", "Summed_MET_minutes_per_week_for_all_activity",
...
# Split female data
train_indices_f3 <- createDataPartition(female_obj3_3$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
# Split male data
train_indices_m3 <- createDataPartition(male_obj3_3$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
set.seed(5)
# Define the model formula
model_formula3 <- Volume_grey_white_normalised ~ cluster + ns(age_at_diagnosis, df = 3) + Qualification_ + ns(Townsend_deprivation_index_at_recruitment, df =3) + Smoking_ever + Drinking_ever + ns(Summed_MET_minutes_per_week_for_all_activity, df=3) +
              Hypertension + Hyperlipidemia + Insulin_medication + Glucose_lowering_medication + Hypertension_medication + Lipid_lowering_medication + Coronary_heart_disease + Depression + Kidney_disease
...
# Model 3 female
model3_f <- lm(model_formula3, data = train_female_obj3_3)
summary(model3_f)

# Make predictions on the testing data
predictions_model3_f<- predict(model3_f, newdata = test_female_obj3_3)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model3_f - test_female_obj3_3$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model3_f - test_female_obj3_3$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the non-spline model
model3_f_aic <- AIC(model3_f)
model3_f_bic <- BIC(model3_f)

# Print the results
cat("AIC for the model3_f:", model3_f_aic, "\n")
cat("BIC for the model3_f:", model3_f_bic, "\n")

# Plot predictions vs actual values
plot(test_female_obj3_3$Volume_grey_white_normalised, predictions_model3_f,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
```
```{r plot_model3_f}
...
# Fit the spline model with ns-splines (degree = 3)
spline_model3f <- lm(Volume_grey_white_normalised ~ ns(age_at_diagnosis, df = 3), data = train_female_obj3_3)
summary(spline_model)
...
preds_model3 <- predict(spline_model3f, newdata = data.frame(age_at_diagnosis = age_grid), se.fit = TRUE)
...
# Plot for model3_f
plot_model3 <- ggplot(train_female_obj3_3, aes(x = age_at_diagnosis, y = Volume_grey_white_normalised)) +
  geom_point(alpha = 0.3, aes(color = "Observed Data")) +
...
# Model 3 male
model3_m <- lm(model_formula3, data = train_male_obj3_3)
summary(model3_m)

# Make predictions on the testing data
predictions_model3_m<- predict(model3_m, newdata = test_male_obj3_3)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model3_m - test_male_obj3_3$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model3_m - test_male_obj3_3$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model3_m_aic <- AIC(model3_m)
model3_m_aic <- BIC(model3_m)

# Print the results
cat("AIC for the model3_m:", model3_m_aic, "\n")
cat("BIC for the model3_m:", model3_m_aic, "\n")

# Plot predictions vs actual values
plot(test_male_obj3_3$Volume_grey_white_normalised, predictions_model3_m,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
```
```{r plot_model3_m}
...
relevant_vars_4 <- c("Volume_grey_white_normalised", "cluster", "age_at_diagnosis", 
                     "Qualification_", "Townsend_deprivation_index_at_recruitment", 
                     "Smoking_ever", "Drinking_ever", "Summed_MET_minutes_per_week_for_all_activity",
...
# Split female data
train_indices_f4 <- createDataPartition(female_obj3_4$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
# Split male data
train_indices_m4 <- createDataPartition(male_obj3_4$Volume_grey_white_normalised, p = 0.8, list = FALSE)
...
set.seed(5)
# Define the model formula
model_formula4 <- Volume_grey_white_normalised ~ cluster + ns(age_at_diagnosis, df = 3) + Qualification_ + ns(Townsend_deprivation_index_at_recruitment, df =3) + Smoking_ever + Drinking_ever + ns(Summed_MET_minutes_per_week_for_all_activity, df=3) +
              Hypertension + Hyperlipidemia + Insulin_medication + Glucose_lowering_medication + Hypertension_medication + Lipid_lowering_medication + Coronary_heart_disease + Depression + Kidney_disease + PRS
...
# Model 3 female
model4_f <- lm(model_formula4, data = train_female_obj3_4)
summary(model4_f)

# Make predictions on the testing data
predictions_model4_f<- predict(model4_f, newdata = test_female_obj3_4)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model4_f - test_female_obj3_4$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model4_f - test_female_obj3_4$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model4_f_aic <- AIC(model4_f)
model4_f_bic <- BIC(model4_f)

# Print the results
cat("AIC for the model4_f:", model4_f_aic, "\n")
cat("BIC for the model4_f:", model4_f_bic, "\n")

# Plot predictions vs actual values
plot(test_female_obj3_4$Volume_grey_white_normalised, predictions_model4_f,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
```
```{r plot_model4_f}
...
# Model 4 male
model4_m <- lm(model_formula4, data = train_male_obj3_4)
summary(model4_m)

# Make predictions on the testing data
predictions_model4_m<- predict(model4_m, newdata = test_male_obj3_4)


# Calculate Mean Absolute Error (MAE)
mae <- mean(abs(predictions_model4_m - test_male_obj3_4$Volume_grey_white_normalised))
cat("Mean Absolute Error (MAE):", mae, "\n")

# Calculate Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((predictions_model4_m - test_male_obj3_4$Volume_grey_white_normalised)^2))
cat("Root Mean Squared Error (RMSE):", rmse, "\n")

# Calculate AIC and BIC for the model
model4_m_aic <- AIC(model4_m)
model4_m_bic <- BIC(model4_m)

# Print the results
cat("AIC for the model4_m:", model4_m_aic, "\n")
cat("BIC for the model4_m:", model4_m_bic, "\n")

# Plot predictions vs actual values
plot(test_male_obj3_4$Volume_grey_white_normalised, predictions_model4_m,
     xlab = "Actual Values", ylab = "Predicted Values", main = "Predicted vs Actual Values")
abline(0, 1, col = "red")  # Line for perfect prediction
```
```{r plot_model4_m}
...
ggplot(male_obj3_4, aes(x = age_trans, y = Volume_grey_white_normalised)) +
  geom_point() +
  geom_smooth(method = "loess", se = FALSE, color = "blue") +
  ggtitle("Relationship between Age at Diagnosis and Volume of Grey White Normalised") +
  xlab("Age at Diagnosis") +
  ylab("Volume of Grey White Normalised")

# Plot for Townsend Deprivation Index
ggplot(male_obj3_4, aes(x = Townsend_deprivation_index_at_recruitment, y = Volume_grey_white_normalised)) +
  geom_point() +
  geom_smooth(method = "loess", se = FALSE, color = "red") +
  ggtitle("Relationship between Townsend Deprivation Index and Volume of Grey White Normalised") +
  xlab("Townsend Deprivation Index") +
  ylab("Volume of Grey White Normalised")

# Plot for Summed MET Minutes per Week for All Activity
ggplot(male_obj3_4, aes(x = Summed_MET_minutes_per_week_for_all_activity, y = Volume_grey_white_normalised)) +
  geom_point() +
  geom_smooth(method = "loess", se = FALSE, color = "green") +
  ggtitle("Relationship between Summed MET Minutes per Week and Volume of Grey White Normalised") +
  xlab("Summed MET Minutes per Week") +
  ylab("Volume of Grey White Normalised")

# Plot for PRS
ggplot(male_obj3_4, aes(x = PRS, y = Volume_grey_white_normalised)) +
  geom_point() +
  geom_smooth(method = "loess", se = FALSE, color = "purple") +
  ggtitle("Relationship between PRS and Volume of Grey White Normalised") +
  xlab("PRS") +
  ylab("Volume of Grey White Normalised")
...
```{r anova_compare}
anova(model2_f, model3_f ,model4_f, test = "Chisq")
```
...
# VIF
vif_values <- car::vif(model4_m)
print(vif_values)

vif_values <- car::vif(model4_f)
print(vif_values)
```
...
```{r}
# Define the models
models_f <- list(model1_f, model2_f, model3_f, model4_f)
models_m <- list(model1_m, model2_m, model3_m, model4_m)
...
ggplot(coeff_combined_f, aes(x = Volume, y = term, color = model, group = model)) +
  ...
  theme_minimal() +
  labs(title = "Forest Plot of Female Regression Models for Brain Volume", x = "Brain volume grey + white matter (mm3)", y = "Type 2 Diabetes sub-phenotype") +
...
ggplot(coeff_combined_m, aes(x = Volume, y = term, color = model, group = model)) +
  ...
  geom_errorbar(aes(xmin = Volume - std.error, xmax = Volume + std.error), 
                position = position_dodge(width = 0.5), width = 0.2) +
  theme_minimal() +
  labs(title = "Forest Plot of Male Regression Models for Brain Volume", x = "Brain volume grey + white matter (mm3)", y = "Type 2 Diabetes sub-phenotype") +
  theme(legend.position = "right") +
    scale_color_brewer(palette="Set2") +
  scale_x_continuous(labels = format_scientific)
```
...
# Create a data frame
data <- data.frame(
  Model = c("Model1_f", "Model2_f", "Model3_f", "Model4_f"),
...
# Create a data frame
data <- data.frame(
  Model = c("Model1_m", "Model2_m", "Model3_m", "Model4_m"),
